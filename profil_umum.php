...
<head>
    ...
    <title>Profil - SMART-BA UIN Palopo</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="profil_umum.php">Profil</a></li>
    ...
    <header class="page-header">
        <div class="container" data-aos="fade-up">
            <h1>Tentang SMART-BA</h1>
            <p class="lead">Inovasi Digital untuk Kampus Cerdas & Hijau</p>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6" data-aos="fade-right">
                    <img src="image_de8089.png" class="img-fluid rounded shadow-lg" alt="Dashboard SMART-BA">
                </div>
                <div class="col-lg-6" data-aos="fade-left" data-aos-delay="100">
                    <h3>Sistem Terpadu untuk Bimbingan Efektif</h3>
                    ...
                    <a href="login.php" class="btn btn-primary mt-3" style="background-color: var(--green-primary); border:none; padding: 10px 25px;">Masuk ke Sistem</a>
                </div>
            </div>
        </div>
    </section>
